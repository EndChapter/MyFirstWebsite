...
<html>
  ...
  <body>
        ...
        <div class="nav-wrapper purple darken-3">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            foreach($dbh->query('SELECT * from Linkler') as $row) {
              if($row["href"] == "reklam"){
                echo "<li><a class=\"hover3\" href=\"#\">Reklam</a></li>";
    ...
    <ul class="sidenav deep-purple lighten-4" id="mobile-demo">
      ...
      foreach($dbh->query('SELECT * from Linkler') as $row) {
        if($row["href"] == "reklam"){
          echo "<li><a class=\"waves-effect waves-purple btn-flat\" href=\"#\">Reklam</a></li>";
        }else if($row["href"]== "home"){
    ...
    <div class="container section white">
      <div class="row container">
          <h2 class="header">Reklam</h2>
          <p class="grey-text text-darken-3 lighten-3">Reklam ve işbirliği için iletişim adresleri: edipididi@gmail.com</p-->
