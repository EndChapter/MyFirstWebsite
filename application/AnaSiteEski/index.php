  ...
  <div class="container section white">
    ...
    <ul class="pagination">
      ...
      if ($sayfa == 1){
        ...
        echo "<li class=\"\"><a href=\"/?sayfa=".($sayfa-1)."\"><i class=\"material-icons\">chevron_left</i></a></li>";
      }
        ...
        echo "<li class=\"waves-effect\"><a href=\"/?sayfa=".($sayfa+1)."\"><i class=\"material-icons\">chevron_right</i></a></li>";
      }else{
